...
![[_The Presentation of Self in Everyday Life_#^fb159d]]

The issue, of course, is that once we have chosen a mask, we must maintain it. (See Valentine's "Intelligent Social Web.") We must not present ourselves in ways that contradict the definition advanced by the mask. Alternate displays feel "off-brand." In an algorithmic age, the penalization of off-brandedness is taken to a new extreme. We accumulate followers and engagement under one banner, and when we publish something that is not of interest to them, that hits a different sensibility, it not only "falls flat" but the low engagement causes the publication to sink further into obscurity. It not merely "different content," it is "bad content."